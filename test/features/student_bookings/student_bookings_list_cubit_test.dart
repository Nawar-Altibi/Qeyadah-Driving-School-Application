...
void main() {
  ...
  group('StudentBookingsListCubit', () {
    ...
    blocTest<StudentBookingsListCubit, StudentBookingsListState>(
      ...
      build: () {
        when(
          () => repository.getBookings(any(), forceRefresh: any(named: 'forceRefresh')),
    ...
    blocTest<StudentBookingsListCubit, StudentBookingsListState>(
      ...
      build: () {
        when(() => repository.getBookings(any(), forceRefresh: any(named: 'forceRefresh'))).thenAnswer(
      ...
      verify: (c) {
        ...
        verifyNever(() => repository.getBookings(any(), forceRefresh: any(named: 'forceRefresh')));
      },
    );
    ...
    blocTest<StudentBookingsListCubit, StudentBookingsListState>(
      ...
      verify: (c) {
        ...
        verify(() => repository.getBookings(any(), forceRefresh: any(named: 'forceRefresh'))).called(2);
      },
    );
  });
}
